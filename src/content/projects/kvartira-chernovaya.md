...
gallery:
  ...
  - src: /img/projects/kvartira-chernovaya/loggia.webp
    alt: 'Остеклённая лоджия с керамогранитом'
order: 55
publishDate: 2026-02-08
---

Объект в работе. Слайдер показывает черновой пол со стяжкой и маяками (ДО) и выровненный наливной пол (ПОСЛЕ).

## Этапы

- Демонтаж и подготовка основания
- Стяжка по маякам, наливной самовыравнивающийся пол
